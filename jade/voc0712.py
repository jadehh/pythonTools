...
# VOC_CLASSES = ( '__background__', # always index 0
#     'mzy-mzyglny-pz-blw-450ml', 'ty-hzy-pz-gw-500ml', 'wlj-wljlc-hz-yw-250ml', 'yb-ybcjs-pz-yw-555ml',
#     'asm-asmnc-pz-yw-500ml', 'nfsq-nfsqyytrs-pz-yw-550ml', 'yy-yylght-gz-ht-240ml', 'nfsq-nfsqjjydyl-pz-nmw-550ml','ksf-ksfmlqc-pz-yw-500ml','ksf-ksfmlmc-pz-yw-500ml')


#VOC_CLASSES = GetVOC_CLASSES("/home/jade/Data/StaticDeepFreeze/Goods.prototxt")
...
class VOCDetection():
    ...
    def pull_image(self, index):
        ...
        '''
        img_id = self.ids[index]
        return cv2.imread(self._imgpath % img_id),self._imgpath % img_id
